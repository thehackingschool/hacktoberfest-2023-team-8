...
def get_DataLoader(args):
    if args.dataset == 'food101':
        ...
        nutrition_test_txt = os.path.join(args.data_root, 'imagery','rgbd_test_processed1.txt') # depth_color.png
        nutrition_train_rgbd_txt = os.path.join(args.data_root, 'imagery','rgb_in_overhead_train_processed.txt')
        nutrition_test_rgbd_txt = os.path.join(args.data_root, 'imagery','rgb_in_overhead_test_processed1.txt') # rbg.png
